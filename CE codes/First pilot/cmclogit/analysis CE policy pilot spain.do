cd "/home/sara/Documents/A-Planet/Askill stata codes/First pilot/cmclogit"
...
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 if d_madrid==1, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV_Price_O EV_Price_U d_Rev2-d_Rev5, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV_Price_O EV_Price_U d_Rev2-d_Rev5 if d_madrid==1, nocons
...
cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 if d_madrid==1, nocons
...
eststo clear
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment2 if mod<2, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment2 if mod<2&d_madrid==1, nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment2 Price_O EV d_Rev2-d_Rev5 if mod<2, nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment2 Price_O EV d_Rev2-d_Rev5 if mod<2&d_madrid==1, nocons
eststo: cmclogit choice policy Price_U_avg Price_O c.EV##c.d_treatment2 d_Rev2-d_Rev5 if mod<2, nocons
eststo: cmclogit choice policy Price_U_avg Price_O c.EV##c.d_treatment2 d_Rev2-d_Rev5 if mod<2&d_madrid==1, nocons
...
cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment2 if mod<2&d_madrid==1, nocons
margins, dydx(d_treatment2) outcome(1) alt(1) post
*margins, dydx(d_treatment2) outcome(2) alt(2) post
qui cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment2 if mod<2&d_madrid==1, nocons
margins, at(d_treatment2=0) at(d_treatment2=1) contrast(at(r)) outcome(1) alt(1) post

cmclogit choice policy c.Price_U_avg##c.d_treatment2 Price_O EV d_Rev2-d_Rev5 if mod<2&d_madrid==1, nocons
margins, dydx(Price_U_avg) at(d_treatment2=0) at(d_treatment2=1) contrast(at(r)) outcome(1) alt(1)

cmclogit choice policy Price_U_avg Price_O c.EV##c.d_treatment2 d_Rev2-d_Rev5 if mod<2&d_madrid==1, nocons
...
eststo clear
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment3 if (mod==0|mod==2), nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment3 if (mod==0|mod==2)&d_madrid==1, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment3 c.d_Rev1#c.d_treatment3 if (mod==0|mod==2), nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment3 c.d_Rev1#c.d_treatment3 if (mod==0|mod==2)&d_madrid==1, nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment3 Price_O EV c.EV#c.d_treatment3 d_Rev2-d_Rev5 c.d_Rev1#c.d_treatment3 if (mod==0|mod==2), nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment3 Price_O EV c.EV#c.d_treatment3 d_Rev2-d_Rev5 c.d_Rev1#c.d_treatment3 if (mod==0|mod==2)&d_madrid==1, nocons
...
eststo clear
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment4 if (mod==0|mod==3), nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment4 if (mod==0|mod==3)&d_madrid==1, nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment4 c.d_Rev3#c.d_treatment4 if (mod==0|mod==3), nocons
eststo: cmclogit choice policy Price_U_avg Price_O EV d_Rev2-d_Rev5 d_treatment4 c.d_Rev3#c.d_treatment4 if (mod==0|mod==3)&d_madrid==1, nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment4 Price_O EV c.EV#c.d_treatment4 d_Rev2-d_Rev5 c.d_Rev3#c.d_treatment4 if (mod==0|mod==3), nocons
eststo: cmclogit choice policy c.Price_U_avg##c.d_treatment4 Price_O EV c.EV#c.d_treatment4 d_Rev2-d_Rev5 c.d_Rev3#c.d_treatment4 if (mod==0|mod==3)&d_madrid==1, nocons
...
eststo: cmclogit choice policy Price_U_avg c.Price_U_avg#c.concern_fairness Price_O EV c.EV#c.concern_fairness d_Rev2-d_Rev5 c.d_Rev3#c.concern_fairness if (mod==0|mod==3)&d_madrid==1, nocons
...
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==1, nocons
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==2, nocons
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==3, nocons
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==4, nocons
...
eststo clear 
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==1, nocons constraints(1)
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==2, nocons constraints(1)
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==3, nocons constraints(1)
eststo: cmclogit choice policy Price_UR Price_UN Price_O EV d_Rev2-d_Rev5 if mod==4, nocons constraints(1)
...
cmclogit choice policy Price_UR Price_UN Price_O d_Rev* EV c.EV#mod c.d_Rev*#mod i.treatment, nocons
